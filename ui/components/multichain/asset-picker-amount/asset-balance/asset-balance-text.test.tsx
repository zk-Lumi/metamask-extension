...
describe('AssetBalanceText', () => {
    ...
    it('matches snapshot', () => {
        ...
        const { asFragment } = render(<Provider>store, { store } >
            <AssetBalanceText>asset, { asset }, balanceColor = { 'textColor': as, TextColor }
            /  >
            <>/Provider>,);
    ...
    it('renders fiat primary correctly', () => {
        ...
        const { getByText } = render(<Provider>store, { store } >
            { /* Replace `any` with type */}, { /* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
    ...
    it('renders error correctly', () => {
        ...
        const { getByText } = render(<Provider>store, { store } >
            <AssetBalanceText>asset, { asset }, balanceColor = { 'textColor': as, TextColor }, error = "errorText"
            /  >
            <>/Provider>,);
        expect(getByText('test_balance')).toBeInTheDocument();
