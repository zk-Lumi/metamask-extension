...
describe('Name', () => {
    ...
    it('renders when no address value is passed', () => {
        ...
        const { container } = renderWithProvider(<Name>type, { NameType, : .ETHEREUM_ADDRESS }, value = { '':  }, variation = { VARIATION_MOCK }
            /  > , store);
    ...
    it('renders address with no saved name', () => {
        ...
        const { container } = renderWithProvider(<Name>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_NO_SAVED_NAME_MOCK }, variation = { VARIATION_MOCK }
            /  > , store);
        expect(container).toMatchSnapshot();
    });
    it('renders address with saved name', () => {
        ...
        const { container } = renderWithProvider(<Name>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_SAVED_NAME_MOCK }, variation = { VARIATION_MOCK }
            /  > , store);
        expect(container).toMatchSnapshot();
    });
    ...
    describe('metrics', () => {
        ...
        it.each([
        ...
        ])('sends displayed event with %s name', async (_: string, value: string, hasPetname: boolean) => {
            ...
            renderWithProvider(<MetaMetricsContext.Provider>value, { trackEventMock } >
                <Name>type, { NameType, : .ETHEREUM_ADDRESS }, value = { value }, variation = { VARIATION_MOCK }
                /  >
