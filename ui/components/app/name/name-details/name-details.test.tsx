        ...
        [VARIATION_MOCK]: {
            data: {
                '0x0a3bb08b3a15a19b4de82f8acfc862606fb69a2d': {
                    ...
                    symbol: 'IUSD',
                    name: 'iZUMi Bond USD',
                    iconUrl: 'https://static.cx.metamask.io/api/v1/tokenIcons/1/0x0a3bb08b3a15a19b4de82f8acfc862606fb69a2d.png',
                },
            },
        },
    }
};
async function saveNameUsingDropdown(component: ReturnType<typeof renderWithProvider>, name: string) {
...
async function saveNameUsingTextField(component: ReturnType<typeof renderWithProvider>, name: string) {
    const { getByPlaceholderText, getByText } = component;
    const nameInput = getByPlaceholderText('Choose a nickname...');
    const saveButton = getByText('Save');
    await act(async () => {
...
describe('NameDetails', () => {
    ...
    it('renders when no address value is passed', () => {
        const { baseElement } = renderWithProvider(<NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { '':  }, variation = { VARIATION_MOCK }, onClose = {}());
        undefined;
    }, />,, store);
...
it('renders with no saved name', () => {
    ...
    const { baseElement } = renderWithProvider(<NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_NO_NAME_MOCK }, variation = { VARIATION_MOCK }, onClose = {}());
    undefined;
}, />,, store);
expect(baseElement).toMatchSnapshot();
;
it('renders with saved name', () => {
    const { baseElement } = renderWithProvider(<NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_SAVED_NAME_MOCK }, variation = { VARIATION_MOCK }, onClose = {}());
    undefined;
}, />,, store);
expect(baseElement).toMatchSnapshot();
;
it('renders with recognized name', () => {
    const { baseElement } = renderWithProvider(<NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_RECOGNIZED_MOCK }, variation = { VARIATION_MOCK }, onClose = {}());
    undefined;
}, />,, store);
expect(baseElement).toMatchSnapshot();
;
it('renders proposed names', async () => {
    const component = renderWithProvider(<NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_SAVED_NAME_MOCK }, variation = { VARIATION_MOCK }, onClose = {}());
    undefined;
}, />,, store);
...
it('saves current name on save button click', async () => {
    const component = renderWithProvider(<NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_NO_NAME_MOCK }, variation = { VARIATION_MOCK }, onClose = {}());
    undefined;
}, />,, store);
...
it('updates proposed names', () => {
    renderWithProvider(<NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_NO_NAME_MOCK }, variation = { VARIATION_MOCK }, onClose = {}(), undefined);
}, />,, store);
...
describe('metrics', () => {
    it('sends open modal event', async () => {
        ...
        await act(async () => {
            renderWithProvider(<MetaMetricsContext.Provider>value, { trackEventMock } >
                <NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_SAVED_NAME_MOCK }, variation = { VARIATION_MOCK }, onClose = {}(), undefined);
        }, />
...
it('sends created event', async () => {
    ...
    const trackEventMock = jest.fn();
    const component = renderWithProvider(<MetaMetricsContext.Provider>value, { trackEventMock } >
        <NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_NO_NAME_MOCK }, variation = { VARIATION_MOCK }, onClose = {}());
    undefined;
}, />
    < /MetaMetricsContext.Provider>,, store);
await saveNameUsingDropdown(component, PROPOSED_NAME_MOCK);
...
it('sends updated event', async () => {
    ...
    const trackEventMock = jest.fn();
    const component = renderWithProvider(<MetaMetricsContext.Provider>value, { trackEventMock } >
        <NameDetails>type, { NameType, : .ETHEREUM_ADDRESS }, value = { ADDRESS_SAVED_NAME_MOCK }, variation = { VARIATION_MOCK }, onClose = {}());
    undefined;
}, />
    < /MetaMetricsContext.Provider>,, store);
