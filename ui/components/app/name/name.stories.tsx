...
const ADDRESS_FIRST_PARTY_MOCK = FIRST_PARTY_CONTRACT_NAMES[EXPERIENCES_TYPE.METAMASK_BRIDGE][VARIATION_MOCK].toLowerCase();
...
export default {
    ...
    render: ({ state, ...args }) => {
        ...
        state?.(finalState);
        return (<Provider>store) = { configureStore(finalState); } >
...
export const SavedNameStory = {
    ...
    args: {
        ...
        variation: VARIATION_MOCK,
        state: (state) => {
            state.metamask.names[NameType.ETHEREUM_ADDRESS][ADDRESS_MOCK][VARIATION_MOCK].name = NAME_MOCK;
        },
    },
};
/**
