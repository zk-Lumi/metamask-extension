...
const renderUseBridging = (mockStoreState: object) => renderHookWithProvider(() => useBridging(), mockStoreState);
describe('useBridging', () => {
    ...
    describe('extensionSupport=false, chainId=1', () => {
        ...
        ])('should open %s with the currently selected token: %p', (expectedUrl: string, token: string, location: string, urlSuffix: string) => {
