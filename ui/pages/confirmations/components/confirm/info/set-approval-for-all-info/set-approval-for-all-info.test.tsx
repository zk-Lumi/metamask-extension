...
import { getMockConfirmState, getMockSetApprovalForAllConfirmState, } from '../../../../../../../test/data/confirmations/helper';
...
describe('<SetApprovalForAllInfo />', () => {
    ...
    it('renders component for approve request', async () => {
        ...
        const { container } = renderWithConfirmContextProvider(<SetApprovalForAllInfo>/>,, mockStore);
        await waitFor(() => {
