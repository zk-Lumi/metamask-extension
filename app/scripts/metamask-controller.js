...
export default class MetamaskController extends EventEmitter {
  ...
  constructor(opts) {
    ...
    const resetOnRestartStore = {
      AccountTracker: this.accountTrackerController.state,
      TokenRatesController: this.tokenRatesController.state,
      DecryptMessageController: this.decryptMessageController.state,
      EncryptionPublicKeyController: this.encryptionPublicKeyController.state,
      SignatureController: this.signatureController.state,
      SwapsController: this.swapsController.state,
      BridgeController: this.bridgeController.state,
      BridgeStatusController: this.bridgeStatusController.state,
      EnsController: this.ensController.state,
      ApprovalController: this.approvalController.state,
    ...
    const storeControllersComposedState = {
      ...
      PhishingController: this.phishingController.state,
