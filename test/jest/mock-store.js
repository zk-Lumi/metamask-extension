...
export const createBridgeMockStore = (
  ...
  return {
    ...
    metamask: {
      ...swapsStore.metamask,
      NetworkController: {
        ...swapsStore.metamask.NetworkController,
        ...mockNetworkState(
          { chainId: CHAIN_IDS.MAINNET },
      ...
      GasFeeController: {
        ...swapsStore.metamask.GasFeeController,
        gasFeeEstimates: {
      ...
      CurrencyController: {
        ...swapsStore.metamask.CurrencyController,
        currencyRates: {
      ...
      BridgeController: {
        bridgeState: {
          ...(swapsStore.metamask.BridgeController.bridgeState ?? {}),
          bridgeFeatureFlags: {
